(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[2544],{86434:function(U,L,o){"use strict";o.d(L,{F:function(){return O}});var e=o(32735),h=o(59407),P=o(67879),E=o(20108);const O=(T={},R={})=>{const{id:v="",...S}=T,{get:V}=(0,h.kY)(),{locale:a}=(0,P.Z)(),Z=(0,h.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,E.useQuery)(["roles",v,S],async()=>{const{data:Q}=await V(`/admin/roles/${v??""}`,{params:S});return Q},R);return{roles:e.useMemo(()=>{let Q=[];return m&&(Array.isArray(m.data)?Q=m.data:Q=[m.data]),[...Q].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,Z]),error:M,isError:F,isLoading:g,refetch:b}}},36658:function(U,L,o){"use strict";o.d(L,{V:function(){return P}});var e=o(59407),h=o(20108);const P=(E={id:null},O={})=>{const{id:T,...R}=E,{get:v}=(0,e.kY)(),{data:S,error:V,isError:a,isLoading:Z,refetch:m}=(0,h.useQuery)(["roles",T,"permissions",R],async()=>{const{data:{data:M}}=await v(`/admin/roles/${T}/permissions`,{params:R});return M},O);return{permissions:S,error:V,isError:a,isLoading:Z,refetch:m}}},15570:function(U,L,o){"use strict";o.r(L),o.d(L,{CreatePage:function(){return me},default:function(){return Ae}});var e=o(32735),h=o(95162),P=o(64092),E=o(84642),O=o(91779),T=o(56932),R=o(77981),v=o(8365),S=o(10710),V=o(97037),a=o(2846),Z=o(15367),m=o(59407),M=o(70788),F=o(14723),g=o(92802),b=o(86834),z=o.n(b),Q=o(67879),oe=o(15062),ee=o(53038),C=o(8471),de=o(30305),J=o(93985),te=o(91720),Y=o(36658),ue=o(24346),Le=ue.Ry().shape({name:ue.Z_().required(m.I0.required),description:ue.Z_().required(m.I0.required)});const ce=C.ZP.div`
...
`;const ze=({children:t,isCollapsable:n,isActive:r,isFormDisabled:s,label:i,onChange:l,onClick:c,checkboxName:d,someChecked:p,value:u})=>{const{formatMessage:f}=(0,Z.Z)();return e.createElement(b.k,{alignItems:"center",paddingLeft:6,style:{width:Me,flexShrink:0}},e.createElement(m.x,{paddingRight:2},e.createElement(z.C,{name:d,"aria-label":f({id:"Settings.permissions.select-all-by-permission",defaultMessage:"Select all {label} permissions"},{label:i}),disabled:s,onValueChange:x=>l({target:{name:d,value:x}}),indeterminate:p,value:u})),e.createElement(at,{title:i,alignItems:"center",isCollapsable:n,...n&&{onClick:c,"aria-expanded":r,onKeyDown:({key:x})=>(x==="Enter"||x===" ")&&c(),tabIndex:0,role:"button"}},e.createElement(N.Z,{fontWeight:r?"bold":"",textColor:r?"primary600":"neutral800",ellipsis:!0},he()(i)),t))};ze.defaultProps={children:null,checkboxName:"",onChange(){},value:!1,someChecked:!1,isCollapsable:!1},ze.propTypes={checkboxName:a().string,children:a().node,label:a().string.isRequired,isCollapsable:a().bool,isFormDisabled:a().bool.isRequired,onChange:a().func,onClick:a().func.isRequired,someChecked:a().bool,value:a().bool,isActive:a().bool.isRequired};var it=(0,e.memo)(ze),Wt=o(72091),Vt=o.n(Wt),Kt=o(85973),Re=o.n(Kt);const lt=t=>Re()(t)?Vt()(Object.values(t).map(n=>Re()(n)?lt(n):n)):[];var Ie=lt,Ye=t=>t?Object.keys(t).reduce((n,r)=>(r!=="conditions"&&(n[r]=t[r]),n),{}):null,Oe=t=>{const n=Ye(t),r=Ie(n);if(!r.length)return{hasAllActionsSelected:!1,hasSomeActionsSelected:!1};const s=r.every(l=>l),i=r.some(l=>l)&&!s;return{hasAllActionsSelected:s,hasSomeActionsSelected:i}},Ut=o(91917),Ve=(0,g.ZP)(Ut.Z)`
  display: none;
  width: ${10/16}rem;
...
`,pt=({availableActions:t,isActive:n,isGrey:r,isFormDisabled:s,label:i,onClickToggle:l,pathToData:c})=>{const[d,p]=(0,e.useState)(!1),{formatMessage:u}=(0,Z.Z)(),{modifiedData:f,onChangeParentCheckbox:x,onChangeSimpleCheckbox:$}=Y(),W=()=>{p(H=>!H)},I=()=>{p(!1)},A=C()(f,c.split(".."),{}),y=(0,e.useMemo)(()=>Object.keys(A).reduce((H,q)=>(H[q]=J()(A[q],"conditions"),H),{}),[A]),{hasAllActionsSelected:k,hasSomeActionsSelected:D}=Oe(y),B=(0,e.useMemo)(()=>Ht(t,f,c),[t,f,c]),se=B.some(({hasConditions:H})=>H);return e.createElement(Gt,{isActive:n},e.createElement(ct,{isGrey:r},e.createElement(it,{isCollapsable:!0,isFormDisabled:s,label:i,checkboxName:c,onChange:x,onClick:l,someChecked:D,value:k,isActive:n},e.createElement(ut,{paddingLeft:2},n?e.createElement(Q.Z,null):e.createElement(oe.Z,null))),e.createElement(b.k,{style:{flex:1}},B.map(({actionId:H,hasConditions:q,hasAllActionsSelected:K,hasSomeActionsSelected:fe,isDisplayed:ke,isParentCheckbox:ie,checkboxName:Ee,label:Ue})=>ke?ie?e.createElement(dt,{key:H,justifyContent:"center",alignItems:"center"},q&&e.createElement(mt,null),e.createElement(z.C,{disabled:s,name:Ee,"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${Ue} ${i}`}),onValueChange:$e=>{x({target:{name:Ee,value:$e}})},indeterminate:fe,value:K})):e.createElement(dt,{key:H,justifyContent:"center",alignItems:"center"},q&&e.createElement(mt,null),e.createElement(z.C,{disabled:s,indeterminate:q,name:Ee,onValueChange:$e=>{$({target:{name:Ee,value:$e}})},value:K})):e.createElement(Ge,{key:H}))),d&&e.createElement(ve,{headerBreadCrumbs:[i,"Settings.permissions.conditions.conditions"],actions:B,isFormDisabled:s,onClosed:I,onToggle:W})),e.createElement(zt,null,e.createElement(me,{onClick:W,hasConditions:se})))};pt.propTypes={availableActions:a().array.isRequired,isActive:a().bool.isRequired,isGrey:a().bool.isRequired,isFormDisabled:a().bool.isRequired,label:a().string.isRequired,onClickToggle:a().func.isRequired,pathToData:a().string.isRequired};var Yt=pt;const Xt=g.ZP.span`
  color: ${({theme:t})=>t.colors.danger700};
  padding-left: ${({theme:t})=>t.spaces[1]}px;
`;var gt=()=>e.createElement(Xt,null,"*"),wt=(t,n)=>t.map(r=>{const s=Array.isArray(r.subjects)&&r.subjects.indexOf(n)!==-1;return{...r,isDisplayed:s}});const Qt=(0,g.ZP)(m.x)`
...
`,In=g.ZP.div`
  ...
  `}
`,At=({categoryName:t,isFormDisabled:n,subCategoryName:r,actions:s,pathToData:i})=>{const[l,c]=(0,e.useState)(!1),{modifiedData:d,onChangeParentCheckbox:p,onChangeSimpleCheckbox:u}=Y(),{formatMessage:f}=(0,Z.Z)(),x=C()(d,i,{}),$=(0,e.useMemo)(()=>Object.keys(x).reduce((B,se)=>(B[se]=Ye(x[se]),B),{}),[x]),{hasAllActionsSelected:W,hasSomeActionsSelected:I}=Oe($),A=()=>{c(B=>!B)},y=()=>{c(!1)},k=Dn(s,d,i),D=Ln(C()(d,[...i],{}));return e.createElement(e.Fragment,null,e.createElement(m.x,null,e.createElement(b.k,{justifyContent:"space-between",alignItems:"center"},e.createElement(m.x,{paddingRight:4},e.createElement(N.Z,{variant:"sigma",textColor:"neutral600"},r)),e.createElement(jn,null),e.createElement(m.x,{paddingLeft:4},e.createElement(Rt.X,{name:i.join(".."),disabled:n,onValueChange:B=>{p({target:{name:i.join(".."),value:B}})},indeterminate:I,value:W},f({id:"app.utils.select-all",defaultMessage:"Select all"})))),e.createElement(b.k,{paddingTop:6,paddingBottom:6},e.createElement(On.r,{gap:2,style:{flex:1}},k.map(({checkboxName:B,value:se,action:H,displayName:q,hasConditions:K})=>e.createElement($n.P,{col:3,key:H},e.createElement(In,{disabled:n,hasConditions:K},e.createElement(Rt.X,{name:B,disabled:n,onValueChange:fe=>{u({target:{name:B,value:fe}})},value:se},q))))),e.createElement(me,{hasConditions:D,onClick:A}))),l&&e.createElement(ve,{headerBreadCrumbs:[t,r],actions:k,isFormDisabled:n,onClosed:y,onToggle:A}))};At.propTypes={actions:a().array.isRequired,categoryName:a().string.isRequired,isFormDisabled:a().bool.isRequired,subCategoryName:a().string.isRequired,pathToData:a().array.isRequired};var kn=At;const et=({childrenForm:t,kind:n,name:r,isOpen:s,isFormDisabled:i,isWhite:l,onOpenCategory:c,pathToData:d})=>{const{formatMessage:p}=(0,Z.Z)(),u=()=>{c(r)},f=(0,e.useMemo)(()=>r.split("::").pop(),[r]);return e.createElement(Tn.U,{expanded:s,onToggle:u,id:`accordion-${r}`,variant:l?"primary":"secondary"},e.createElement(Sn.B,{title:he()(f),description:`${p({id:"Settings.permissions.category"},{category:f})} ${n==="plugins"?"plugin":n}`}),e.createElement(Mn.v,null,e.createElement(m.x,{padding:6},t.map(({actions:x,subCategoryName:$,subCategoryId:W})=>e.createElement(kn,{key:$,actions:x,categoryName:f,isFormDisabled:i,subCategoryName:$,pathToData:[...d,W]})))))};et.defaultProps={},et.propTypes={childrenForm:a().array.isRequired,isOpen:a().bool.isRequired,isFormDisabled:a().bool.isRequired,isWhite:a().bool.isRequired,kind:a().string.isRequired,name:a().string.isRequired,onOpenCategory:a().func.isRequired,pathToData:a().array.isRequired};var Bn=et;const Tt=({isFormDisabled:t,kind:n,layout:r})=>{const[s,i]=(0,e.useState)(null),l=c=>{i(c===s?null:c)};return e.createElement(m.x,{padding:6,background:"neutral0"},r.map(({category:c,categoryId:d,childrenForm:p},u)=>e.createElement(Bn,{key:c,childrenForm:p,kind:n,isFormDisabled:t,isOpen:s===c,isWhite:u%2===1,name:c,onOpenCategory:l,pathToData:[n,d]})))};Tt.propTypes={isFormDisabled:a().bool.isRequired,kind:a().string.isRequired,layout:a().arrayOf(a().shape({category:a().string.isRequired,categoryId:a().string.isRequired,childrenForm:a().arrayOf(a().shape({actions:a().array.isRequired})).isRequired}).isRequired).isRequired};var St=Tt,Zn=o(86349),Fn=o.n(Zn),Nn=o(3040),ge=o.n(Nn),Mt=(t,n,r)=>t.find(s=>s.action===n&&s.subject===r);const Ot=(t,n=[])=>t.reduce((r,s)=>(r[s.id]=n.indexOf(s.id)!==-1,r),{}),$t=({children:t},n,r="")=>t.reduce((s,i)=>{if(i.children)return{...s,[i.value]:$t(i,n,`${r}${i.value}.`)};const l=n.indexOf(`${r}${i.value}`)!==-1;return s[i.value]=l,s},{}),Wn=(t,n,r)=>t.reduce((s,i)=>{const l=n.properties.find(({value:c})=>c===i);if(l){const c=C()(r,["properties",l.value],[]),d=$t(l,c);s.properties[i]=d}return s},{properties:{}}),Vn=(t,n)=>n.reduce((r,s)=>{const i=t.find(({uid:l})=>l===s)||null;return i&&(r[s]=i),r},{});var Dt=({subjects:t},n,r,s=[])=>n.reduce((i,l)=>{const c=l.subjects,d=Vn(t,c);if(S()(d))return i;const p=Object.keys(d).reduce((u,f)=>{const{actionId:x,applyToProperties:$}=l,A=d[f].properties.map(({value:B})=>B).every(B=>($||[]).indexOf(B)===-1),y=Mt(s,x,f),k=Ot(r,C()(y,"conditions",[]));if(S()($)||A)return ge()(u,[f,x],{properties:{enabled:y!==void 0},conditions:k}),u;const D=Wn($,d[f],y);return ge()(u,[f,x],{...D,conditions:k}),u},{});return Fn()(i,p)},{});const Kn=(t,n,r)=>t.reduce((s,i)=>{const l=Mt(r,i.action,null);return s[i.action]={properties:{enabled:l!==void 0},conditions:Ot(n,l?.conditions??[])},s},{}),Un=(t,n,r)=>t.reduce((s,i)=>(s[i.subCategoryId]=Kn(i.actions,n,r),s),{});var Lt=(t,n,r=[])=>t.reduce((s,{categoryId:i,childrenForm:l})=>{const c=Un(l,n,r);return s[i]=c,s},{});const jt=t=>t.split(" ").join("-");var It=(t,n)=>Object.entries(G()(t,n)).map(([r,s])=>({category:r,categoryId:jt(r),childrenForm:Object.entries(G()(s,"subCategory")).map(([i,l])=>({subCategoryName:i,subCategoryId:jt(i),actions:l}))})),Hn=(t,n)=>{const{conditions:r,sections:{collectionTypes:s,singleTypes:i,plugins:l,settings:c}}=t,d={collectionTypes:s,singleTypes:i,plugins:It(l,"plugin"),settings:It(c,"category")},p={collectionTypes:Dt(s,s.actions||[],r,n),singleTypes:Dt(i,i.actions||[],r,n),plugins:Lt(d.plugins,r,n),settings:Lt(d.settings,r,n)};return{initialData:p,modifiedData:p,layouts:d}},Gn=o(99381),tt=o.n(Gn);const kt=t=>Object.keys(t).reduce((n,r)=>{const s=t[r];if(Re()(s)&&!R()(s,"conditions"))return{...n,[r]:kt(s)};if(Re()(s)&&R()(s,"conditions")&&!Ie(J()(s,"conditions")).some(l=>l)){const l=Object.keys(s.conditions).reduce((c,d)=>(c[d]=!1,c),{});return{...n,[r]:{...s,conditions:l}}}return n[r]=s,n},{});var nt=kt;const Bt=(t,n,r=!1)=>Object.keys(t).reduce((s,i)=>{const l=t[i];return i==="conditions"&&!r?(s[i]=l,s):Re()(l)?{...s,[i]:Bt(l,n,i==="fields")}:(s[i]=n,s)},{});var He=Bt;const zn={initialData:{},modifiedData:{},layouts:{}};var Yn=(t,n)=>(0,re.ZP)(t,r=>{switch(n.type){case"ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX":{const{collectionTypeKind:s,actionId:i,value:l}=n,c=["modifiedData",s];Object.keys(C()(t,c)).forEach(d=>{const p=C()(t,[...c,d,i],void 0);if(p){let u=He(p,l);if(!l&&u.conditions){const f=He(u.conditions,!1);u={...u,conditions:f}}ge()(r,[...c,d,i],u)}});break}case"ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX":{const{pathToCollectionType:s,propertyName:i,rowName:l,value:c}=n;let d=tt()(t.modifiedData);const p=s.split(".."),u=C()(d,p,{});Object.keys(u).forEach(f=>{if(R()(u[f],`properties.${i}`)){const x=C()(u,[f,"properties",i,l]),$=[...p,f,"properties",i,l];if(!Re()(x))ge()(d,$,c);else{const W=He(x,c);ge()(d,$,W)}}}),c||(d=nt(d)),ge()(r,"modifiedData",d);break}case"ON_CHANGE_CONDITIONS":{Object.entries(n.conditions).forEach(s=>{const[i,l]=s;ge()(r,["modifiedData",...i.split(".."),"conditions"],l)});break}case"ON_CHANGE_SIMPLE_CHECKBOX":{let s=tt()(t.modifiedData);ge()(s,[...n.keys.split("..")],n.value),n.value||(s=nt(s)),ge()(r,"modifiedData",s);break}case"ON_CHANGE_TOGGLE_PARENT_CHECKBOX":{const{keys:s,value:i}=n,l=[...s.split("..")];let c=tt()(t.modifiedData);const d=C()(c,l,{}),p=He(d,i);ge()(c,l,p),i||(c=nt(c)),ge()(r,["modifiedData"],c);break}case"RESET_FORM":{r.modifiedData=t.initialData;break}case"SET_FORM_AFTER_SUBMIT":{r.initialData=t.modifiedData;break}default:return r}});const st=t=>Object.entries(t).filter(([,n])=>n).map(([n])=>n),Xn=t=>{const[n,{conditions:r}]=t;return{action:n,subject:null,conditions:st(r),properties:{}}},wn=t=>Object.values(t).reduce((n,r)=>{const s=Object.entries(r).reduce((i,l)=>{const[,{properties:{enabled:c}}]=l;if(!c)return i;const d=Xn(l);return i.push(d),i},[]);return[...n,...s]},[]);var Zt=t=>Object.values(t).reduce((n,r)=>{const s=wn(r);return[...n,...s]},[]);const Ft=(t,n="")=>Object.entries(t).reduce((r,s)=>{const[i,l]=s;return Re()(l)?[...r,...Ft(l,`${n}${i}.`)]:(l&&!Re()(l)&&r.push(`${n}${i}`),r)},[]),Qn=(t,n,{conditions:r,properties:s})=>Object.entries(s).reduce((i,l)=>{const[c,d]=l;return i.properties[c]=Ft(d),i},{action:t,subject:n,conditions:st(r),properties:{}}),Jn=(t,n,{conditions:r})=>({action:t,subject:n,properties:{},conditions:st(r)}),qn=(t,n)=>Object.entries(n).reduce((s,i)=>{const[l,c]=i;if(!Ie(c).some(u=>u))return s;if(!c?.properties?.enabled){const u=Qn(l,t,c);return[...s,u]}if(!c.properties.enabled)return s;const p=Jn(l,t,c);return s.push(p),s},[]);var Nt=t=>Object.entries(t).reduce((r,s)=>{const[i,l]=s,c=qn(i,l);return[...r,...c]},[]),_n=t=>{const n=Zt(t.plugins),r=Zt(t.settings),s=Nt(t.collectionTypes),i=Nt(t.singleTypes);return[...n,...r,...s,...i]},es=[{labelId:"app.components.LeftMenuLinkContainer.collectionTypes",defaultMessage:"Collection Types",id:"collectionTypes"},{labelId:"app.components.LeftMenuLinkContainer.singleTypes",id:"singleTypes",defaultMessage:"Single Types"},{labelId:"app.components.LeftMenuLinkContainer.plugins",defaultMessage:"Plugins",id:"plugins"},{labelId:"app.components.LeftMenuLinkContainer.settings",defaultMessage:"Settings",id:"settings"}];const ot=(0,e.forwardRef)(({layout:t,isFormDisabled:n,permissions:r},s)=>{const[{initialData:i,layouts:l,modifiedData:c},d]=(0,e.useReducer)(Yn,zn,()=>Hn(t,r)),{formatMessage:p}=(0,Z.Z)();(0,e.useImperativeHandle)(s,()=>({getPermissions(){const I=(0,O.e5)(i.collectionTypes,c.collectionTypes),A=(0,O.e5)(i.singleTypes,c.singleTypes),y={...I,...A};let k;return S()(y)?k=!1:k=Object.values(y).some(D=>Object.values(D).some(B=>R()(B,"conditions"))),{permissionsToSend:_n(c),didUpdateConditions:k}},resetForm(){d({type:"RESET_FORM"})},setFormAfterSubmit(){d({type:"SET_FORM_AFTER_SUBMIT"})}}));const u=(I,A,y,k)=>{d({type:"ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX",pathToCollectionType:I,propertyName:A,rowName:y,value:k})},f=(I,A,y)=>{d({type:"ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX",collectionTypeKind:I,actionId:A,value:y})},x=I=>{d({type:"ON_CHANGE_CONDITIONS",conditions:I})},$=(0,e.useCallback)(({target:{name:I,value:A}})=>{d({type:"ON_CHANGE_SIMPLE_CHECKBOX",keys:I,value:A})},[]),W=(0,e.useCallback)(({target:{name:I,value:A}})=>{d({type:"ON_CHANGE_TOGGLE_PARENT_CHECKBOX",keys:I,value:A})},[]);return e.createElement(An,{value:{availableConditions:t.conditions,modifiedData:c,onChangeConditions:x,onChangeSimpleCheckbox:$,onChangeParentCheckbox:W,onChangeCollectionTypeLeftActionRowCheckbox:u,onChangeCollectionTypeGlobalActionCheckbox:f}},e.createElement(h.v,{id:"tabs",label:p({id:"Settings.permissions.users.tabs.label",defaultMessage:"Tabs Permissions"})},e.createElement(P.m,null,es.map(I=>e.createElement(P.O,{key:I.id},p({id:I.labelId,defaultMessage:I.defaultMessage})))),e.createElement(E.n,{style:{position:"relative"}},e.createElement(E.x,null,e.createElement(xt,{layout:l.collectionTypes,kind:"collectionTypes",isFormDisabled:n})),e.createElement(E.x,null,e.createElement(xt,{layout:l.singleTypes,kind:"singleTypes",isFormDisabled:n})),e.createElement(E.x,null,e.createElement(St,{layout:l.plugins,kind:"plugins",isFormDisabled:n})),e.createElement(E.x,null,e.createElement(St,{layout:l.settings,kind:"settings",isFormDisabled:n})))))});ot.defaultProps={permissions:[],layout:{conditions:[],sections:{collectionTypes:{},singleTypes:{actions:[]},settings:[],plugins:[]}}},ot.propTypes={layout:a().object,isFormDisabled:a().bool.isRequired,permissions:a().array};var ts=(0,e.memo)(ot)},87056:function(U,L,o){"use strict";o.r(L),o.d(L,{default:function(){return xe}});var e=o(32735),h=o(59407),P=o(15062),E=o(53038),O=o(30305),T=o(95162),R=o(64092),v=o(84642),S=o(91779),V=o(56932),a=o(77981),Z=o(70788),m=o(92802),M=o(67879),F=o(86434),g=o(91720),b=o(36658),z=o(93985),Q=o(8365),oe=o(10710),ee=o(97037),C=o(2846),de=o(15367),J=o(60216),te=o.n(J);const Y=({disabled:N,role:w,values:j,errors:_,onChange:re,onBlur:ye})=>{const{formatMessage:G}=(0,M.Z)();return e.createElement(a.x,{background:"neutral0",padding:6,shadow:"filterShadow",hasRadius:!0},e.createElement(v.k,{direction:"column",alignItems:"stretch",gap:4},e.createElement(v.k,{justifyContent:"space-between"},e.createElement(a.x,null,e.createElement(a.x,null,e.createElement(Q.Z,{fontWeight:"bold"},w?w.name:G({id:"global.details",defaultMessage:"Details"}))),e.createElement(a.x,null,e.createElement(Q.Z,{textColor:"neutral500",variant:"pi"},w?w.description:G({id:"Settings.roles.form.description",defaultMessage:"Name and description of the role"})))),e.createElement(S.z,{disabled:!0,variant:"secondary"},G({id:"Settings.roles.form.button.users-with-role",defaultMessage:"{number, plural, =0 {# users} one {# user} other {# users}} with this role"},{number:w.usersCount}))),e.createElement(oe.r,{gap:4},e.createElement(ee.P,{col:6},e.createElement(C.o,{disabled:N,name:"name",error:_.name&&G({id:_.name}),label:G({id:"global.name",defaultMessage:"Name"}),onChange:re,onBlur:ye,required:!0,value:j.name||""})),e.createElement(ee.P,{col:6},e.createElement(de.g,{disabled:N,label:G({id:"global.description",defaultMessage:"Description"}),id:"description",error:_.name&&G({id:_.name}),onChange:re,onBlur:ye},j.description||"")))))};Y.defaultProps={disabled:!1,role:null,values:{name:"",description:""}},Y.propTypes={disabled:te().bool,errors:te().object.isRequired,onBlur:te().func.isRequired,onChange:te().func.isRequired,role:te().object,values:te().object};var ue=Y,be=o(24346),ce=be.Ry().shape({name:be.Z_().required(h.I0.required)}),Ae=()=>{const N=(0,h.lm)(),{formatMessage:w}=(0,M.Z)(),{params:{id:j}}=(0,E.$B)("/settings/roles/:id"),{put:_}=(0,h.kY)(),[re,ye]=(0,e.useState)(!1),G=(0,e.useRef)(),{lockApp:Pe,unlockApp:he}=(0,h.o1)(),{trackUsage:Be}=(0,h.rS)(),{formatAPIError:Ce}=(0,h.So)(),{isLoading:Ze,data:Fe}=(0,g.d)(j,{cacheTime:0}),{roles:[pe={}],isLoading:Te,refetch:Ne}=(0,F.F)({id:j},{cacheTime:0}),{permissions:We,isLoading:Se}=(0,b.V)({id:j},{cacheTime:0}),ae=async ve=>{try{Pe(),ye(!0);const{permissionsToSend:ne,didUpdateConditions:Me}=G.current.getPermissions();await _(`/admin/roles/${j}`,ve),pe.code!=="strapi-super-admin"&&(await _(`/admin/roles/${j}/permissions`,{permissions:ne}),Me&&Be("didUpdateConditions")),G.current.setFormAfterSubmit(),await Ne(),N({type:"success",message:{id:"notification.success.saved"}})}catch(ne){N({type:"warning",message:Ce(ne)})}finally{ye(!1),he()}},le=!Te&&pe.code==="strapi-super-admin";return e.createElement(T.o,null,e.createElement(h.SL,{name:"Roles"}),e.createElement(m.J9,{enableReinitialize:!0,initialValues:{name:pe.name,description:pe.description},onSubmit:ae,validationSchema:ce,validateOnChange:!1},({handleSubmit:ve,values:ne,errors:Me,handleChange:je,handleBlur:rt})=>e.createElement("form",{onSubmit:ve},e.createElement(R.T,{primaryAction:e.createElement(v.k,{gap:2},e.createElement(S.z,{disabled:pe.code==="strapi-super-admin",onClick:ve,loading:re,size:"L"},w({id:"global.save",defaultMessage:"Save"}))),title:w({id:"Settings.roles.edit.title",defaultMessage:"Edit a role"}),subtitle:w({id:"Settings.roles.create.description",defaultMessage:"Define the rights given to the role"}),navigationAction:e.createElement(h.rU,{startIcon:e.createElement(Z.Z,null),to:"/settings/roles"},w({id:"global.back",defaultMessage:"Back"}))}),e.createElement(V.D,null,e.createElement(v.k,{direction:"column",alignItems:"stretch",gap:6},e.createElement(ue,{isLoading:Te||Se,disabled:le,errors:Me,values:ne,onChange:je,onBlur:rt,role:pe}),!Ze&&!Te&&!Se?e.createElement(a.x,{shadow:"filterShadow",hasRadius:!0},e.createElement(z.Z,{isFormDisabled:le,permissions:We,ref:G,layout:Fe})):e.createElement(a.x,{background:"neutral0",padding:6,shadow:"filterShadow",hasRadius:!0},e.createElement(h.dO,null)))))))},xe=()=>{const N=(0,P.v9)(O._),{isLoading:w,allowedActions:{canRead:j,canUpdate:_}}=(0,h.ss)({read:N.settings.roles.read,update:N.settings.roles.update});return w?e.createElement(h.dO,null):!j&&!_?e.createElement(E.l_,{to:"/"}):e.createElement(Ae,null)}},91720:function(U,L,o){"use strict";o.d(L,{d:function(){return P}});var e=o(59407),h=o(20108);const P=(E,O={})=>{const{get:T}=(0,e.kY)(),{data:R,error:v,isError:S,isLoading:V}=(0,h.useQuery)(["permissions",E],async()=>{const{data:{data:a}}=await T("/admin/permissions",{params:{role:E}});return a},O);return{data:R,error:v,isError:S,isLoading:V}}},84802:function(U){function L(o,e,h,P){for(var E=-1,O=o==null?0:o.length;++E<O;){var T=o[E];e(P,T,h(T),o)}return P}U.exports=L},62435:function(U,L,o){var e=o(56671);function h(P,E,O,T){return e(P,function(R,v,S){E(T,R,O(R),S)}),T}U.exports=h},85580:function(U,L,o){var e=o(84802),h=o(62435),P=o(88904),E=o(77236);function O(T,R){return function(v,S){var V=E(v)?e:h,a=R?R():{};return V(v,T,P(S,2),a)}}U.exports=O},72091:function(U,L,o){var e=o(40314),h=1/0;function P(E){var O=E==null?0:E.length;return O?e(E,h):[]}U.exports=P},81346:function(U,L,o){var e=o(40999),h=o(85580),P=Object.prototype,E=P.hasOwnProperty,O=h(function(T,R,v){E.call(T,v)?T[v].push(R):e(T,v,[R])});U.exports=O},9435:function(U,L,o){"use strict";o.d(L,{U:function(){return Z},y:function(){return V}});var e=o(74512),h=o(32735),P=o(8471),E=o(85612),O=o(37808),T=o(8365),R=o(84642),v=o(77981);const S=({theme:m,expanded:M,variant:F,disabled:g,error:b})=>b?`1px solid ${m.colors.danger600} !important`:g?`1px solid ${m.colors.neutral150}`:M?`1px solid ${m.colors.primary600}`:F==="primary"?`1px solid ${m.colors.neutral0}`:`1px solid ${m.colors.neutral100}`,V=(0,P.ZP)(T.Z)``,a=(0,P.ZP)(v.x)`
  border: ${S};
...
`,Z=({children:m,disabled:M=!1,error:F,expanded:g=!1,hasErrorMessage:b=!0,id:z,onToggle:Q,toggle:oe,size:ee="M",variant:C="primary",shadow:de})=>{const J=(0,O.M)(z),te=h.useMemo(()=>({expanded:g,onToggle:Q,toggle:oe,id:J,size:ee,variant:C,disabled:M}),[M,g,J,Q,ee,oe,C]);return(0,e.jsxs)(E.S.Provider,{value:te,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:M,"aria-disabled":M,expanded:g,hasRadius:!0,variant:C,error:F,shadow:de,children:m}),F&&b&&(0,e.jsx)(v.x,{paddingTop:1,children:(0,e.jsx)(T.Z,{variant:"pi",textColor:"danger600",children:F})})]})}},79624:function(U,L,o){"use strict";o.d(L,{v:function(){return E}});var e=o(74512),h=o(85612),P=o(77981);const E=({children:O,...T})=>{const{expanded:R,id:v}=(0,h.A)();if(!R)return null;const S=`accordion-content-${v}`,V=`accordion-label-${v}`,a=`accordion-desc-${v}`;return(0,e.jsx)(P.x,{role:"region",id:S,"aria-labelledby":V,"aria-describedby":a,...T,children:O})}},85612:function(U,L,o){"use strict";o.d(L,{A:function(){return P},S:function(){return h}});var e=o(32735);const h=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),P=()=>(0,e.useContext)(h)},9379:function(U,L,o){"use strict";o.d(L,{B:function(){return m}});var e=o(74512),h=o(91917),P=o(8471),E=o(9435),O=o(85612);const T=({expanded:M,disabled:F,variant:g})=>{let b="neutral100";return M?b="primary100":F?b="neutral150":g==="primary"&&(b="neutral0"),b};var R=o(43743),v=o(18129),S=o(84642),V=o(8365);const a=(0,P.ZP)(R.A)`
  text-align: left;
