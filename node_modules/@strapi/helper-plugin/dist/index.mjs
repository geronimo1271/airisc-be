...
const FilterListURLQuery = ({ filtersSchema = [] }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: (_d = (_c = query == null ? void 0 : query.filters) == null ? void 0 : _c.$and) == null ? void 0 : _d.map((filter, i) => {
    var _a2, _b2;
...
const OverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxs(OverlayBlockerContext.Provider, { value: contextValue, children: [
    children,
    isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? createPortal(/* @__PURE__ */ jsx(Overlay, { id: "overlayBlocker" }), globalThis.document.body) : null
  ] });
};
