...
const FilterListURLQuery = ({ filtersSchema = [] }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: (_d = (_c = query == null ? void 0 : query.filters) == null ? void 0 : _c.$and) == null ? void 0 : _d.map((filter, i) => {
    var _a2, _b2;
...
const Blocker = ({ displayedIcon, description, title, isOpen }) => {
  var _a;
  const { formatMessage } = reactIntl.useIntl();
  return isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? reactDom.createPortal(
...
const OverlayBlockerProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(OverlayBlockerContext.Provider, { value: contextValue, children: [
    children,
    isOpen && ((_a = globalThis == null ? void 0 : globalThis.document) == null ? void 0 : _a.body) ? reactDom.createPortal(/* @__PURE__ */ jsxRuntime.jsx(Overlay, { id: "overlayBlocker" }), globalThis.document.body) : null
  ] });
};
