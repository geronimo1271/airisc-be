...
declare const _default: ({ build, watchAdmin, polling, browser }: CmdOptions) => Promise<void | ({
    server: import("@strapi/types").Server;
    container: import("@strapi/types").Container;
    log: import("winston").Logger;
    fs: import("@strapi/types").StrapiFS;
    eventHub: import("@strapi/types").EventHub;
    startupLogger: import("@strapi/types").StartupLogger;
    cron: import("@strapi/types").CronService;
    webhookRunner?: import("../../../services/webhook-runner").WebhookRunner | undefined;
    webhookStore?: import("@strapi/types").WebhookStore | undefined;
    store?: import("@strapi/types").CoreStore | undefined;
    entityValidator?: import("@strapi/types").EntityValidator | undefined;
    entityService?: import("@strapi/types/dist/modules/entity-service").EntityService | undefined;
    telemetry: import("@strapi/types").TelemetryService;
    requestContext: import("@strapi/types").RequestContext;
    customFields: import("@strapi/types/dist/modules/custom-fields").CustomFields;
    fetch: import("@strapi/types").Fetch;
    dirs: import("@strapi/types").StrapiDirectories;
    ...
    load(): Promise<any & Required<Strapi>>;
